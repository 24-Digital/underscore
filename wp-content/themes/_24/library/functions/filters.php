 ...
 * Filters
 *
 * @version      1.0 | 22nd August 2014
 * @package      WordPress
 * @subpackage   _24
 *
 * Filters, largely adapted from Samurai: https://github.com/beaucharman/samurai
 *
 */
...
class filter
{
    ...
    public function __construct()
    {
        ...
        /* Debug */
        if (_24_TEMPLATE_DEBUG && ! is_admin())
        {
            ...
            elseif (strpos($args[0], 'get_template_part_') === 0)
            {
                ...
                if ($last_template_snoop)
                {
                    echo "\n\n<!-- debug: End Template Part: {$last_template_snoop} "
                        . "[turn this debug mode off in functions.php] -->";
                }
